...
class JPortalDumper {
  ...
  public:
    ...
    static address copy_data(address dest, address src, size_t size) {
      if (size == 0)
        return dest;
    ...
    static void jportal_compiled_method_load(Method *moop,
    ...
    static void jportal_compiled_method_unload(Method *moop, address code_begin);
