...
#if defined(linux)
#if defined(__x86_64__)
  JPortalDumper::jportal_compiled_method_load(moop,
      insts_begin(), insts_size() + stub_size(),
      (address)scopes_pcs_begin(), scopes_pcs_size(),
      scopes_data_begin(), scopes_data_size(),
      metadata_begin(), metadata_count(),
...
#if defined(linux)
#if defined(__x86_64__)
  JPortalDumper::jportal_compiled_method_unload(method(), insts_begin());
#endif
#endif
