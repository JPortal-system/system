...
#define RUNTIME_FLAGS(develop, \
  ...
  product(bool, JPortalTrace, false,                                        \
          "Enable JPortal Trace")                                           \
                                                                            \
  product(bool, JPortalDump, false,                                         \
          "Enable JPortal Dump")                                            \
                                                                            \
  product(bool, JPortalMethod, false,                                       \
          "Enable JPortal Method Dump")                                     \
                                                                            \
  product(ccstrlist, JPortalMethodFilters, "",                              \
          "JPortal method filters")                                         \
                                                                            \
  product(ccstrlist, JPortalClassFilters, "",                               \
          "JPortal class filters")                                          \
                                                                            \
